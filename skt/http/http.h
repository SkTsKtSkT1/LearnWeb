#ifndef LEARNWEB_HTTP_H
#define LEARNWEB_HTTP_H
...
public:
    ...
    void setCookie(const std::string& key, const std::string& v);
    ...
    template<class T>
    bool checkGetHeadrAs(const std::string& key, T& val, const T& def = T()){
