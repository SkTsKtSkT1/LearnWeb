#ifndef LEARNWEB_SOCKET_H
#define LEARNWEB_SOCKET_H
...
public:
    ...
    static Socket::ptr CreateTCP(skt::Address::ptr address);
    static Socket::ptr CreateUDP(skt::Address::ptr address);
